    ...
    <div>
      ...
      <nav className="bg-gray-900 text-white px-6 py-4 flex items-center justify-between shadow">
        ...
        <div className="flex space-x-6">
          <a href="#" className="hover:text-blue-400 transition font-semibold underline underline-offset-4">Dashboard</a>
      ...
      <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold mb-6">DeviceIQ Dashboard</h1>
